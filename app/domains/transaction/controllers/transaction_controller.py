...
@router.get("/recent", operation_id="get_recent_transactions_transaction_controller")
...
@router.get("/", operation_id="get_all_transactions_transaction_controller")
...
@router.get("/stats", operation_id="get_transaction_stats_transaction_controller")
